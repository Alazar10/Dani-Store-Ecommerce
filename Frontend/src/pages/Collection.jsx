  ...
  return (
    <div className="flex flex-col sm:flex-row gap-4 sm:gap-10 pt-10 border-t px-6">
        ...
        <div className="border border-gray-300 pl-5 py-3 mt-4">
          ...
          >
            {fixedPriceFilters.map((price, index) => (
              <label
                key={index}
                className={`flex gap-2 cursor-pointer p-2 rounded ${selectedPrice === price.label ? "bg-blue-100 text-blue-700" : ""
                  }`}
        ...
        <div className="border border-gray-300 pl-5 py-3 mt-4">
          ...
          >
            {categories.map((category, index) => (
              <label
                key={index}
                className={`flex gap-2 cursor-pointer p-2 rounded ${selectedCategories.includes(category) ? "bg-blue-100 text-blue-700" : ""
                  }`}
      ...
      <div className="flex-1">
        ...
        {/* Product list display would go here */}
      </div>
    </div>
  );
};
